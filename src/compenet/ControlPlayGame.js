    ...
    <div>
      {gameState==='start'||gameState==='lose'||gameState==='win'
        ?<div style={{textAlign:'center'}}>
          <h1 style={{color:'goldenrod',marginTop:'25vh',textShadow:'5px 5px 5px black'}}>The Memory Card Game</h1>
          <h3 style={{color:'goldenrod',marginTop:'5vh',textShadow:'#e27777 2px 3px 5px'}}>{gameState==='lose'?'You Lost Try Again':gameState==='win'?`It Is Win Go To Level ${result.level}`:''}</h3>
